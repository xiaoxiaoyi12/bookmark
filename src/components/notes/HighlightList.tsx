...
export default function HighlightList({ bookId, onDelete }: Props) {
  ...
  return (
    <div className="border-t border-amber-200 dark:border-gray-700">
      <h3 className="px-4 py-2 text-xs font-semibold text-amber-600/50 dark:text-gray-500 uppercase select-none">
        高亮 ({highlights.length})
      </h3>
      <div className="max-h-60 overflow-y-auto">
        {highlights.map(h => (
          <div key={h.id} className="group px-4 py-2 border-b border-amber-100 dark:border-gray-800 hover:bg-amber-50/50 dark:hover:bg-gray-800/50">
